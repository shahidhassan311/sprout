...
export default{
    created: function () {
        ...
        $(function () {
            $("#duplicate").on("click",function () {
                alert("are you sure Duplicate customers");
                self.btnlinks.duplicatebtnlink ="/sales/salescustomerduplicate/"+self.$route.params.id;
            });
            $("#delete").click(function () {
                self.submit();
                alert("are you sure delete customers");
            ...
            self.btnlinks.editbtnlink ="/sales/salescustomeredit/"+self.$route.params.id;
        })
    },
    props: [
        "edit",
    ...
    methods: {
        ...
        submit: function () {
            var self = this;
            self.$http.post("/sales/contactdeletes", {"id": self.$route.params.id}).then(function(res){
        ...
        select: function () {
            var self = this;
            self.$http.post("/sales/ctag", {"id": self.$route.params.id}).then(function (res) {
                var tags = res.body.data[0];
                self.tid = tags.tag_id;
                self.$http.post("/sales/ctags", {"tid":self.tid}).then(function (res) {
                    var data = res.body.data[0];
