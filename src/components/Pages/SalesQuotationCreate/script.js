...
export default{
    created: function () {
        ...
        $("#customer_m4").hide();
        $(function(){
            $('#select_mo').on('change',function(){
                var ab = $('#select_mo option:selected').val();
                if(ab== null){
                    $('#customer_m').hide();
                }
                else{
            ...
            $('#select_mo1').on('change',function(){
                var ab = $('#select_mo1 option:selected').val();
                if(ab== null){
                    $('#customer_m1').hide();
                }
                else{
            ...
            $('#select_mo2').on('change',function(){
                var ab = $('#select_mo2 option:selected').val();
                if(ab== null){
                    $('#customer_m2').hide();
                }
                else{
            ...
            $('#select_mo3').on('change',function(){
                var ab = $('#select_mo3 option:selected').val();
                if(ab== null){
                    $('#customer_m3').hide();
                }
                else{
            ...
            $('#select_mo4').on('change',function(){
                var ab = $('#select_mo4 option:selected').val();
                if(ab== null){
                    $('#customer_m4').hide();
                }
                else{
    ...
    methods: {
        ...
        submit: function () {
            ...
            self.$http.post("/sales/sales_quotation_create", {
                ...
                "invoice_address_get": self.invoice_address_get,
                "delivery_address_get": self.delivery_address_get,
                "status": sb,
